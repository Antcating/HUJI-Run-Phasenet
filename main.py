...
if __name__ == "__main__":
    while True:
        ...
        num_files, day_label = build_file_list(
            last_pick_file=last_pick_file,
            one_day=True,
        )
        if num_files == 0:
        ...
        print(f"Built file list with {num_files} files for day {day_label}")

        print(f"Running EQNet for day {day_label}...")
